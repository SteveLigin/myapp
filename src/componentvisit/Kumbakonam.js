...
export default function Kumbakonam() {
  return (
    <div>
    <div>
  <div className="container mt-5 mb-4">
       ...
       <div className="container">
          <div className="row">
              ...
              <img src={require("./img/Kumbakonam/kumbakonam1 (1).jpeg")} style={{ height: '230px',width:'170px' }}></img>
              </div>
       ...
       <div className="container">
          <div className="row">
            ...
            houses three gateway towers known as gopurams.
               ...
               <div className="col-sm-2 mt-5 mb-3">
              <img src={require("./img/Kumbakonam/kumbakonam1 (2).jpeg")} style={{ height: '235px',width:'170px' }}></img>
              </div>
       ...
       <div className="container">
          <div className="row">
              <div className="col-sm-2 mt-5 mb-3">
              <img src={require("./img/Kumbakonam/kumbakonam1 (3).jpeg")} style={{ height: '223px',width:'170px' }}></img>
              </div>
       ...
       <div className="container">
          <div className="row">
            ...
            Yamuna, Subrahmanya, Ganesha, Kama, Rati and others.
               ...
               <div className="col-sm-2 mt-5 mb-3">
              <img src={require("./img/Kumbakonam/kumbakonam1 (4).jpeg")} style={{ height: '230px',width:'170px' }}></img>
              </div>
