    ...
    <div className="container mt-5 mb-4">
         ...
         <div className="container">
            <div className="row">
                ...
                <img src={require("./img/Kodaikanal/kodaikanal1....jpeg")} style={{ height: '195px',width:'170px' }}></img>
                </div>
         ...
         <div className="container">
            <div className="row">
                ...
                <div className="col-sm-10 mt-5 mb-3 pt-2" >
                 ...
                 <div className="col-sm-2 mt-5 mb-3">
                <img src={require("./img/Kodaikanal/kodaikanal2.jpeg")} style={{ height: '195px',width:'170px' }}></img>
                </div>
         ...
         <div className="container">
            <div className="row">
                <div className="col-sm-2 mt-5 mb-3">
                <img src={require("./img/Kodaikanal/kodaikanal3..jpeg")} style={{ height: '220px',width:'170px' }}></img>
                </div>
         ...
         <div className="container">
            ...
            ways become clear nothing beautiful than this could be ever seen.
                 ...
                 <div className="col-sm-2 mt-5 mb-3">
                <img src={require("./img/Kodaikanal/kodaikanal4.jpeg")} style={{ height: '230px',width:'170px' }}></img>
                </div>
