  ...
  <div className="container mt-5 mb-4">
       ...
       <div className="container">
          <div className="row">
              ...
              <img src={require("./img/Theni/theni1.(1).jpeg")} style={{ height: '220px',width:'170px' }}></img>
              </div>
...
when the water level is high and the neighboring areas glows with greenery.
               ...
               <div className="col-sm-2 mt-5 mb-3">
              <img src={require("./img/Theni/theni1 (2).jpeg")} style={{ height: '235px',width:'170px' }}></img>
              </div>
       ...
       <div className="container">
          <div className="row">
              <div className="col-sm-2 mt-5 mb-3">
              <img src={require("./img/Theni/theni1.(3).jpeg")} style={{ height: '242px',width:'170px' }}></img>
              </div>
...
reachable by road from Kambam and Gudalur towns
               ...
               <div className="col-sm-2 mt-5 mb-3">
              <img src={require("./img/Theni/theni1.(4).jpeg")} style={{ height: '235px',width:'170px' }}></img>
              </div>
