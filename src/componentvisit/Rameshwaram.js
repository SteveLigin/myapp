    ...
    <div className="container mt-5 mb-4">
         ...
         <div className="container">
            <div className="row">
                ...
                <img src={require("./img/Rameshwaram/rameshwarem1.jpeg")} style={{ height: '240px',width:'170px' }}></img>
                </div>
         ...
         <div className="container">
            <div className="row">
                ...
                <div className="col-sm-10 mt-5 mb-3 pt-2" >
                 ...
                 <div className="col-sm-2 mt-5 mb-3">
                <img src={require("./img/Rameshwaram/rameshwarem2.jpeg")} style={{ height: '180px',width:'170px' }}></img>
                </div>
         ...
         <div className="container">
            <div className="row">
                <div className="col-sm-2 mt-5 mb-3">
                <img src={require("./img/Rameshwaram/rameshwarem1 (6).jpeg")} style={{ height: '240px',width:'170px' }}></img>
                </div>
         ...
         <div className="container">
            ...
            there are absorbing festivals worth witnessing.
                 ...
                 <div className="col-sm-2 mt-5 mb-3">
                <img src={require("./img/Rameshwaram/Rameshwaram3..jpeg")} style={{ height: '230px',width:'170px' }}></img>
                </div>
