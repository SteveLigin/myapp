  ...
  <div className="container mt-5 mb-4">
       ...
       <div className="container">
          <div className="row">
              ...
              <img src={require("./img/Yercaud/yercaud...(1).jpeg")} style={{ height: '243px',width:'170px' }}></img>
              </div>
...
with sights of the craggy cliffs
       ...
       <div className="container">
          <div className="row">
            ...
            species of plants must make it a point to visit the orchid garden and the green house in the Botanical garden.
               ...
               <div className="col-sm-2 mt-5 mb-3">
              <img src={require("./img/Yercaud/yercaud1 (2).jpeg")} style={{ height: '192px',width:'170px' }}></img>
              </div>
       ...
       <div className="container">
          <div className="row">
              <div className="col-sm-2 mt-5 mb-3">
              <img src={require("./img/Yercaud/yercaud1.(3).jpeg")} style={{ height: '177px',width:'170px' }}></img>
              </div>
...
reflected in its waters
               ...
               <div className="col-sm-2 mt-5 mb-3">
              <img src={require("./img/Yercaud/yercaud1 (4).jpeg")} style={{ height: '237px',width:'170px' }}></img>
              </div>
