  ...
  <div className="container mt-5 mb-4">
       ...
       <div className="container">
          <div className="row">
              ...
              <img src={require("./img/Kanyakumari/kanyakumari1 (1).jpeg")} style={{ height: '200px',width:'170px' }}></img>
              </div>
       ...
       <div className="container">
          <div className="row">
            ...
            life and work in depth.
               ...
               <div className="col-sm-2 mt-5 mb-3">
              <img src={require("./img/Kanyakumari/kanyakumari1.(2).jpeg")} style={{ height: '215px',width:'170px' }}></img>
              </div>
       ...
       <div className="container">
          <div className="row">
              <div className="col-sm-2 mt-5 mb-3">
              <img src={require("./img/Kanyakumari/kanyakumari1 (3).jpeg")} style={{ height: '242px',width:'170px' }}></img>
              </div>
       ...
       <div className="container">
          <div className="row">
            ...
            small temple dedicated to Lord Shiva and is highly revered by the locals.
               ...
               <div className="col-sm-2 mt-5 mb-3">
              <img src={require("./img/Kanyakumari/kanyakumari1 (4).jpeg")} style={{ height: '210px',width:'170px' }}></img>
              </div>
