  ...
  <div className="container mt-5 mb-4">
       ...
       <div className="container">
          <div className="row">
              ...
              <img src={require("./img/Hogenakkal/hogenakkal1.jpeg")} style={{ height: '245px',width:'170px' }}></img>
              </div>
...
medicinal properties, owing to the numerous herbs that grow in its path. Known for its pristine appeal.
               ...
               <div className="col-sm-2 mt-5 mb-3">
              <img src={require("./img/Hogenakkal/hogenakkal2..jpeg")} style={{ height: '215px',width:'170px' }}></img>
              </div>
       ...
       <div className="container">
          <div className="row">
              <div className="col-sm-2 mt-5 mb-3">
              <img src={require("./img/Hogenakkal/hogenakkal3.jpeg")} style={{ height: '222px',width:'170px' }}></img>
              </div>
...
land around it. Another major attraction of the area is a water reservoir flanked by hilly ranges all around.
               ...
               <div className="col-sm-2 mt-5 mb-3">
              <img src={require("./img/Hogenakkal/hokenakkal4..jpeg")} style={{ height: '238px',width:'170px' }}></img>
              </div>
