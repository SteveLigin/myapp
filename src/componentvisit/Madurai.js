  ...
  <div className="container mt-5 mb-4">
       ...
       <div className="container">
          <div className="row">
              ...
              <img src={require("./img/Madurai/madurai1..jpeg")} style={{ height: '243px',width:'170px' }}></img>
              </div>
       ...
       <div className="container">
          <div className="row">
            ...
            metres above sea level, this small mountain village is surrounded by tea and cardamom plantations.
               ...
               <div className="col-sm-2 mt-5 mb-3">
              <img src={require("./img/Madurai/madurai2.jpeg")} style={{ height: '238px',width:'170px' }}></img>
              </div>
       ...
       <div className="container">
          <div className="row">
              <div className="col-sm-2 mt-5 mb-3">
              <img src={require("./img/Madurai/madurai3..jpeg")} style={{ height: '242px',width:'170px' }}></img>
              </div>
       ...
       <div className="container">
          <div className="row">
            ...
            kept for display.
               ...
               <div className="col-sm-2 mt-5 mb-3">
              <img src={require("./img/Madurai/madurai4..jpeg")} style={{ height: '223px',width:'170px' }}></img>
              </div>
