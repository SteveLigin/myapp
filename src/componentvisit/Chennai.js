    ...
    <div className="container mt-5 mb-4">
         ...
         <div className="container">
            <div className="row">
                ...
                <img src={require("./img/Chennai/chennai1.jpeg")} style={{ height: '250px',width:'170px' }}></img>
                </div>
         ...
         <div className="container">
            <div className="row">
                ...
                <div className="col-sm-10 mt-5 mb-3 pt-2" >
                 ...
                 <div className="col-sm-2 mt-5 mb-3">
                <img src={require("./img/Chennai/chennai2.jpeg")} style={{ height: '235px',width:'170px' }}></img>
                </div>
         ...
         <div className="container">
            <div className="row">
                <div className="col-sm-2 mt-5 mb-3">
                <img src={require("./img/Chennai/chennai3...jpeg")} style={{ height: '240px',width:'170px' }}></img>
                </div>
         ...
         <div className="container">
            ...
            is the place to be.
                 ...
                 <div className="col-sm-2 mt-5 mb-3">
                <img src={require("./img/Chennai/chennai4.jpeg")} style={{ height: '170px',width:'170px' }}></img>
                </div>
