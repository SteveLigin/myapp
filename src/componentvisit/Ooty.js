  ...
  <div className="container mt-5 mb-4">
       ...
       <div className="container">
          <div className="row">
              ...
              <img src={require("./img/Ooty/ooty1 (1).jpeg")} style={{ height: '200px',width:'170px' }}></img>
              </div>
       ...
       <div className="container">
          <div className="row">
            ...
            known as the Toda mund, which gives the visitors an insight into the lives and culture of Todas (a tribe of the Nilgiris).
               ...
               <div className="col-sm-2 mt-5 mb-3">
              <img src={require("./img/Ooty/ooty1 (2).jpeg")} style={{ height: '215px',width:'170px' }}></img>
              </div>
       ...
       <div className="container">
          <div className="row">
              <div className="col-sm-2 mt-5 mb-3">
              <img src={require("./img/Ooty/ooty1 (3).jpeg")} style={{ height: '245px',width:'170px' }}></img>
              </div>
       ...
       <div className="container">
          <div className="row">
            ...
            is located at a short distance from the Dolphin's Nose. 
               ...
               <div className="col-sm-2 mt-5 mb-3">
              <img src={require("./img/Ooty/ooty1 (4).jpeg")} style={{ height: '230px',width:'170px' }}></img>
              </div>
